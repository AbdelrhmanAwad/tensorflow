...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::ValuesIn(GetTestParamsOrDie(
        GetAotTestParamsForBackwardsCompatibility("elementwise_aot_test_cpu",
                                                  Platform::kCpu))),
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::ValuesIn(GetTestParamsOrDie(
        GetAotTestParamsForGoldenFileVerification("elementwise_aot_test_cpu",
                                                  Platform::kCpu))),
    [](const ::testing::TestParamInfo<AotTestParam>& info) {
      return absl::StrCat("v", info.param.version);
    });
